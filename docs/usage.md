...
The name on the lower left of the write box is who writes back. Tap it to see every model on your Cursor plan — Auto, Composer, Claude, GPT, Gemini, Grok, and the rest Cursor offers you. Scroll the list, or search if you know the name. The next send uses what you pick. You cannot change it while a reply is still coming.
